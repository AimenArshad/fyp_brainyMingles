...
# student_domain_df = pd.concat([student_domain_df, student_domain_df], sort=False)
# student_language_df = pd.concat([student_language_df, student_language_df],sort=False)

student_domain_df = student_domain_df.drop_duplicates()
student_language_df = student_language_df.drop_duplicates()


student_domain_df.index = student_domain_df.index.astype(str)

# print(student_domain_df)
# print(student_language_df)
...
student_dataFrame = pd.DataFrame(student_data_dict, index=[0])
